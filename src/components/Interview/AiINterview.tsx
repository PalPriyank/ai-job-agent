...
const AiInterview: React.FC<props> = ({
    ...
    setShowQuesions,
    setExperienceRange,
    setExpirationDate, setInterviewTypes, setJobPosition, experienceRange, expirationDate, interviewTypes, jobPosition }) => {
    ...
    return (
        <div>
            ...
            <div className="mb-4">
                <label className="text-purple-700 font-semibold">Experience Range</label>
                <select
            ...
            <div className="mb-4">
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                    {["Technical", "Behavioral", "Leadership", "Problem-Solving", "System Design", "Cultural Fit"].map(type => (
            ...
            <div className="mb-4">
                <label className="text-purple-700 font-semibold">Custom Interview Type</label>
            ...
            <div className="mb-6">
                <label className="text-purple-700 font-semibold">Interview Expiration Date</label>
                <input
                    type="date"
                    ...
                    className="w-full mt-1 p-2 border border-purple-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400"
                />
                <p className="text-sm text-gray-500 mt-1">The interview link will expire after this date.</p>
            </div>
